...
const apiUrl = stripTrailingSlash(
  argValue(args, "--api", process.env.AGENTOPS_API_URL || "https://agentops-ai.netlify.app/api")
);
const webUrl = stripTrailingSlash(
  argValue(args, "--web", process.env.AGENTOPS_WEB_URL || "https://agentops-ai.netlify.app")
);
